...
3. Draft the frontmatter: description, argument-hint if the skill takes user input, disable-model-invocation if the action is consequential or modifies a settings file, allowed-tools scoped to what the steps actually call.
